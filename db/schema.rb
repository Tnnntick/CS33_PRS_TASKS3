...
ActiveRecord::Schema[7.0].define(version: 2023_04_09_235136) do
  ...
  create_table "mainusers", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["email"], name: "index_mainusers_on_email", unique: true
    t.index ["reset_password_token"], name: "index_mainusers_on_reset_password_token", unique: true
  end
